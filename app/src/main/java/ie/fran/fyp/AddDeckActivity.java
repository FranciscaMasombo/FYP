...
import ie.fran.fyp.Flashcards.AddedCardsAdapter;
...
public class AddDeckActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flashcard_activity_add_deck);
        ...
        bd = intent.getExtras();
        if(bd != null) {
            Deck editDeck = (Deck) bd.get(FlashcardsMainActivity.KEY_DECK);
    ...
    public void addCard(){
        ...
        View dialog = inflater.inflate(R.layout.flashcard_dialog_add_card,null);
    ...
    void sendClick() {
        ...
        String message;
        if(bd != null){
            key = (String) bd.get(FlashcardsMainActivity.KEY_KEY);
