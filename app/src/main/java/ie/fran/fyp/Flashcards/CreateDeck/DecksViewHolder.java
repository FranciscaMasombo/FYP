...
import ie.fran.fyp.Flashcards.AddDeckActivity;
import ie.fran.fyp.Flashcards.FlashcardsMainActivity;
import ie.fran.fyp.Flashcards.ViewCardsActivity;
import ie.fran.fyp.R;

public class DecksViewHolder extends RecyclerView.Adapter<DecksViewHolder.ViewHolder> {
    ...
    public DecksViewHolder(Context context, String uId) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.flashcard_row_deck, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(FlashcardsMainActivity.KEY_KEY, deckKeys.get(position));
                intent.putExtra(FlashcardsMainActivity.KEY_DECK, deckList.get(position));
                context.startActivity(intent);
            }
        });
