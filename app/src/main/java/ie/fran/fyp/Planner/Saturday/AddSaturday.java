package ie.fran.fyp.Planner.Saturday;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
                    ...
                    reference.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(AddSaturday.this, " Deleted", Toast.LENGTH_SHORT).show();
                                noteID = "no";
                                finish();
                            } else {
                                Log.e("NewNoteActivity", task.getException().toString());
                                Toast.makeText(AddSaturday.this, "ERROR: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();

                            }
                        }
                    });
                }else {
                    Toast.makeText(AddSaturday.this, " Nothing to delete", Toast.LENGTH_SHORT).show();
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(AddSaturday.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                Thread mainThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        newTaskref.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(AddSaturday.this, "Added to database", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(AddSaturday.this, Saturday.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(intent);
                                } else {
