package ie.fran.fyp.Planner.Wednesday;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
                    ...
                    reference.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(AddWednesday.this, " Deleted", Toast.LENGTH_SHORT).show();
                                noteID = "no";
                                finish();
                            } else {
                                Log.e("NewNoteActivity", task.getException().toString());
                                Toast.makeText(AddWednesday.this, "ERROR: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();

                            }
                        }
                    });
                }else {
                    Toast.makeText(AddWednesday.this, " Nothing to delete", Toast.LENGTH_SHORT).show();
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(AddWednesday.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                Thread mainThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        newTaskref.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(AddWednesday.this, "added to database", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(AddWednesday.this, Wednesday.class);
                                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                    startActivity(intent);
                                } else {
