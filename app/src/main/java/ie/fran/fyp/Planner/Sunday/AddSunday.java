package ie.fran.fyp.Planner.Sunday;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
                    ...
                    reference.child(noteID).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(AddSunday.this, " Deleted", Toast.LENGTH_SHORT).show();
                                noteID = "no";
                                finish();
                            } else {
                                Log.e("NewNoteActivity", task.getException().toString());
                                Toast.makeText(AddSunday.this, "ERROR: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();

                            }
                        }
                    });
                }else {
                    Toast.makeText(AddSunday.this, " Nothing to delete", Toast.LENGTH_SHORT).show();
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(AddSunday.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                Thread mainThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        newTaskref.setValue(noteMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(AddSunday.this, "added to database", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(AddSunday.this, "ERROR: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                }
