...
public class Saturday extends AppCompatActivity {
                        ...
                        if (dataSnapshot.hasChild("title")) {
                            ...
                            viewHolder.weekCard.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    Intent intent = new Intent(Saturday.this, AddSaturday.class);
    ...
    private void updateUI() {
        ...
        if (fAuth.getCurrentUser() != null) {
            ...
            Intent startIntent = new Intent(Saturday.this, LoginActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.add_new_folder:
                Intent newIntent = new Intent(Saturday.this, AddSaturday.class);
